...
CREATE EXTERNAL TABLE survey_responses(pid VARCHAR(8), 
                                       ...
                                       zip VARCHAR(7), 
                                       county VARCHAR(22), 
                                       nurses_comm_ap VARCHAR(2), 
                                       nurses_comm_ip VARCHAR(2), 
                                       nurses_comm_ds VARCHAR(2), 
                                       doctors_comm_ap VARCHAR(2), 
                                       doctors_comm_ip VARCHAR(2), 
                                       doctors_comm_ds VARCHAR(2), 
                                       staff_response_ap VARCHAR(2), 
                                       staff_response_ip VARCHAR(2), 
                                       staff_response_ds VARCHAR(2), 
                                       pain_mgmt_ap VARCHAR(2), 
                                       pain_mgmt_ip VARCHAR(2), 
                                       pain_mgmt_ds VARCHAR(2), 
                                       medicines_comm_ap VARCHAR(2), 
                                       medicines_comm_ip VARCHAR(2), 
                                       medicines_comm_ds VARCHAR(2), 
                                       clean_quiet_ap VARCHAR(2), 
                                       clean_quiet_ip VARCHAR(2), 
                                       clean_quiet_ds VARCHAR(2), 
                                       discharge_info_ap VARCHAR(2), 
                                       discharge_info_ip VARCHAR(2), 
                                       discharge_info_ds VARCHAR(2), 
                                       overall_rating_ap VARCHAR(2), 
                                       overall_rating_ip VARCHAR(2), 
                                       overall_rating_ds VARCHAR(2), 
                                       hcahps_base_score VARCHAR(2), 
                                       hcahps_consist_score VARCHAR(2))
